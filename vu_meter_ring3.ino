...
#define PEAK_FALL        1.5  // Rate of falling peak dot
...
void loop() 
{
  ...
  if (digitalRead(leftButton)){
      ...
      sensitivity= 500; //high sensitivity
    }
  else if (digitalRead(rightButton)){
    
      sensitivity= 1023; //low sensitivity
    }
  ...
  c = fscale(INPUT_FLOOR, sensitivity, numPixels, 0, peakToPeak, 2);
